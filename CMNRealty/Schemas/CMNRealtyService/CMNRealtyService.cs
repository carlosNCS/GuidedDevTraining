    ...
    public class RealtyService : BaseService, IReadOnlySessionState
    {
        ...
        public decimal GetMaxPriceByTypeId(string realtyTypeId, string realtyOfferTypeId)
        {
          ...
          Select select = new Select(UserConnection)
                            .Column(Func.Max("CMNPrice"))
                            .From("CMNRealty")
                            .Where("CMNTypeId").IsEqual(Column.Parameter(new Guid(realtyTypeId)))
                            .And("CMNOfferTypeId").IsEqual(Column.Parameter(new Guid(realtyOfferTypeId)))
                            as Select;
